...
export default function SciFiGenrePage() {
  ...
  // Fetch movies by Science Fiction genre
      ...
      <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-semibold">Science Fiction Movies</h1>
          </div>
        </div>
            ...
            {movies && movies.length > 0 ? (
              ...
              <div className="text-center py-10">
                ...
                <p className="text-sm text-gray-500 max-w-xs mx-auto">
                  We couldn't find any science fiction movies. Please try a different genre.
                </p>
              </div>
            )}
          </>
