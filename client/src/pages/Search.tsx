...
import MovieSearchResults from "@/components/movie/MovieSearchResults";
  ...
  return (
    <div id="search-view">
      ...
      <main className="container mx-auto px-4 py-6">
        {isSearching ? (
          <MovieSearchResults query={submittedTerm} isActive={true} />
        ) : (
          <>
            <div className="mb-6">
                  ...
                  {recentSearches.map((search, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-card rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <button onClick={() => searchWithTerm(search)}>
                          {search}
                        </button>
                      </div>
                      <button 
